'''
This project uses the python turtle to draw a table with a cake and decorations on it, taking users inputs for the width of the table and cake, as well as their colors'''
...
def draw_leg(width, height):
    ...
    draw_rectangle(width, height)  # Leg size fixed
    turtle.left(90)
...
def close():        # Function to ask the user to press any key to exit the drawing
    print("Press any key to exit.")
    turtle.bye()

# Main function to draw the scene
def main():
    turtle.listen()  # Function for the turtle to detect the users keyboard input.
    ...
    # calling the functions: table, cake, and candles, decoration, birthday text, and closing the drawing
